...
class CameraFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val bitmapPrevious = BitmapFactory.decodeResource(requireActivity().resources,
                R.drawable.photo1)
        ...
        binding.arrowNext.setOnClickListener {
            findNavController().navigate(R.id.action_cameraFragment_to_cameraProfileFragment)
        }

        binding.retakePhoto.setOnClickListener {
            if(photoSaved) {
                startCamera()
                binding.newPhoto.visibility = View.GONE
